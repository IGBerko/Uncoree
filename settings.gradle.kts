...
if (!file(".git").exists()) {
    val errorText = """
        ...
        =====================[ ERROR ]=====================
         The Uncoree  project directory is not a properly cloned Git repository.
         
         In order to build Uncoree from source you must clone
         the Paper repository using Git, not download a code
         zip from GitHub.
         
         Built Uncoree jars are available for download at
